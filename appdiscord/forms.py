...
class loginForm(AuthenticationForm):
   ...
   password = forms.CharField(max_length=50, required=True, widget=forms.Password(attrs={'placeholder': 'Password', 'class': 'form-control', 'data-toggle': 'password', 'id': 'password', 'name'='password'}))
